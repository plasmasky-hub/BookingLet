  ...
  return (
    ...
    >
      <Cards elevation={3}>
        ...
        <h4>Lin Yan</h4>
        <p>
          A highly motivated and cooperative front-end developer. Participated
          in two project development. Experience with paid internships in
          commercial projects. Passionate about work and life.
        </p>
        <ButtonIcons
          aria-label="Linkedin"
          onClick={(e) => {
      ...
      <Cards elevation={3}>
        ...
        <p>
          I am a creative thinker and a patient communicator. I can relate well
          with people at all levels and have the flexibility to work well as
          part of a team.
        </p>
        <ButtonIcons
          aria-label="Linkedin"
      ...
      <Cards elevation={3}>
        ...
        <h4>Derek Zhu</h4>
        <p>
          Full-stack developer living in Tasmania. Contributed to both back-end
          development and calendar components of Bookinglet.
        </p>
        <ButtonIcons
          aria-label="Linkedin"
          onClick={(e) => {
      ...
      <Cards elevation={3}>
        ...
        <h4>Anita Liu</h4>
        <p>
          A business graduate with technical skills. Dashing web developer with
      ...
      <Cards elevation={3}>
        ...
        <h4>Xiaoman Li</h4>
        <p>
          A computer science graduate with the background of product design.
          Also did the UI design work for the project. Passionate about creative
          work.{' '}
        </p>
        <ButtonIcons
          aria-label="Linkedin"
          onClick={(e) => {
            e.preventDefault();
            window.open(
              'https://www.linkedin.com/in/andy-xiaoman-li',
              '_blank'
            );
          }}
        >
      ...
      <Cards elevation={3}>
        ...
        <h4>Yiyuan Tang</h4>
        <p>
          Results-driven computer science student from the University of
          Adelaide passionate about full-stack development.
        </p>
        <ButtonIcons
          aria-label="Linkedin"
          onClick={(e) => {
      ...
      <Cards elevation={3}>
        ...
        <h4>Xiang Ji</h4>
        <p>
          Graduated from the University of Adelaide with 2 years of experience
          in coding. Have strong interests in full-stack and network security.
        </p>
        <ButtonIcons
          aria-label="Linkedin"
          onClick={(e) => {
