...
serviceInfoRouter.post('/:serviceInfoId/rootCategory/:rootCategoryId', addRootCategoryToServiceInfo);
serviceInfoRouter.delete('/:serviceInfoId/rootCategory/:rootCategoryId',removeRootCategoryToServiceInfo);
